...
### TASK_069: 프로젝트 서버 카드 드롭다운 메뉴 및 확인 다이얼로그 구현
...
- [ ] **TASK_069_02: 삭제 확인 다이얼로그 구현**
  - [ ] MCP 서버 이름 정확히 입력해야 하는 확인 다이얼로그
  - [ ] 프론트엔드에서 이름 일치 검증
  - [ ] 삭제 실행 시 기존 API 호출

- [ ] **TASK_069_03: 편집 기능 연동**
  - [ ] 기존 `AddServerDialog` 편집 모드 연동
  - [ ] 드롭다운에서 편집 클릭 시 기존 핸들러 호출

## Progress Status
- Current Progress: TASK_069_01 시작 - 프로젝트 서버 카드 ... 드롭다운 메뉴 구현 중
- Next Task: TASK_069_02 - 삭제 확인 다이얼로그 구현
- Last Update: 2025-06-17
- Automatic Check Feedback: 서버 카드 UX 개선을 위한 드롭다운 메뉴 통합 작업 진행
