...
- [x] **문제 분석**
  - [x] 프론트엔드는 이메일 주소로 초대 요청
  - [x] 백엔드는 UUID만 받도록 구현되어 422 에러 발생
  - [x] 업계 표준 분석: GitHub, Slack 등 모두 이메일 기반 초대

- [x] **백엔드 API 수정**
  - [x] ProjectMemberCreate 모델 수정 (user_id → email)
  - [x] 이메일로 기존 사용자 조회 로직 추가
